...
from deepfuse_2.ssim_loss_function import SSIM_LOSS
from deepfuse_2.deep_fuse_net import DeepFuseNet
from deepfuse_2.utils import get_train_images
    ...
    with tf.Graph().as_default(), tf.Session() as sess:
        ...
        for epoch in range(EPOCHS):
            ...
            for batch in range(n_batches):
                ...
                original_batch = original_batch.reshape([BATCH_SIZE, HEIGHT, WIDTH, CHANNELS])
        ...
        scio.savemat('D:/Deepfuse_youngpoong/result/DeepFuseLossData.mat', {'loss': loss_data})
