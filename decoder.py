...
class Decoder(object):
    ...
    def __init__(self, model_pre_path):
        ...
        with tf.variable_scope('decoder'):
            self.weight_vars.append(self._create_variables(8, 8, 3, scope='conv2_1'))
            self.weight_vars.append(self._create_variables(8, 4, 3, scope='conv2_2'))
            self.weight_vars.append(self._create_variables(4, 1, 3, scope='conv2_3'))
